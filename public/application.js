...
var onUpdateBoard = function onUpdateBoard(event) {
  // saves this event to use later
  event.preventDefault();
  store.playerClick = event;
  api.update(event).then(ui.updateBoardSuccess).catch(ui.updateBoardFailure);
};
...
var updateGameLogic = function updateGameLogic() {
...
module.exports = {
  ...
  updateGameLogic: updateGameLogic
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
